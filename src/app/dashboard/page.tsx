    ...
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-4 sm:p-6 w-full">
          <h2 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Active Projects Progress</h2>
        ...
        {/* Upcoming Deadlines */}
        <div className="bg-white rounded-lg shadow p-4 sm:p-6 w-full">
          <h2 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Upcoming Deadlines</h2>
        ...
        {/* Task Distribution */}
        <div className="bg-white rounded-lg shadow p-4 sm:p-6 w-full">
          <h2 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Task Distribution by Assignee</h2>
          <div className="w-full overflow-x-auto">
