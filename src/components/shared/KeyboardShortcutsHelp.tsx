      ...
      <div className="space-y-6">
              ...
              <div key={category}>
                ...
                <div className="space-y-2">
                  {shortcuts.map((shortcut: any) => (
                    <div
                      key={shortcut.name}
                      className="flex items-center justify-between py-2 px-3 rounded-lg hover:bg-gray-50:bg-gray-700 transition-colors"
                    >
                      <span className="text-sm text-gray-900">
                        {shortcut.description}
                      </span>
                      <kbd className="inline-flex items-center gap-1 px-3 py-1.5 text-xs font-semibold text-gray-800 bg-gray-100 border border-gray-200 rounded-lg">
        ...
        <div className="pt-4 border-t border-gray-200">
          <p className="text-xs text-gray-500 text-center">
            Press <kbd className="px-2 py-1 text-xs font-semibold text-gray-800 bg-gray-100 border border-gray-200 rounded">Shift + ?</kbd> to toggle this help
          </p>
        </div>
      </div>
    </Modal>
